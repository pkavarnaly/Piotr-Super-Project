...
class AddCustomer:
    ...
    # btnSave_xpath = "//a[@class='btn bg-blue']"
    btnSave_xpath = "//button[@name='save' and @class='btn bg-blue']"
    ...
    # def setCustomerRoles(self, role):
     ...
     #   elif role == 'Guests':
      ...
      #      time.sleep(3)
     #       self.driver.find_element_by_xpath("//*[@id='SelectCustomerRoleIds_taglist']/li/span[2]").click()
